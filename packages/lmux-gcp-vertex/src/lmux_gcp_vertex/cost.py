    ...
    "claude-opus-4-1": ModelPricing(
        tiers=[
            PricingTier(
                ...
                cache_creation_cost_per_token_by_ttl={"1h": per_million_tokens(30.0)},
            ),
        ],
    ),
    ...
    "claude-3-5-haiku": ModelPricing(
        tiers=[
            PricingTier(
                ...
                cache_creation_cost_per_token_by_ttl={"1h": per_million_tokens(1.6)},
            ),
        ],
    ),
    ...
    "claude-3-haiku": ModelPricing(
        tiers=[
            PricingTier(
                ...
                cache_read_cost_per_token=per_million_tokens(0.03),
                cache_creation_cost_per_token=per_million_tokens(0.3),
                cache_creation_cost_per_token_by_ttl={"1h": per_million_tokens(0.5)},
            ),
        ],
    ),
