...
def _map_content_part(part: TextContent | ImageContent) -> "ChatCompletionContentPartParam":
...
# MARK: Output Mappers (Groq SDK responses -> lmux)


def _map_function_tool_call(tc: "ChatCompletionMessageToolCall") -> ToolCall:
    return ToolCall(
        id=tc.id,
