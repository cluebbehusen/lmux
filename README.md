...
| AWS Bedrock            | `additionalModelRequestFields.thinking` — adaptive + `output_config.effort` on Claude 4.6+, budget tokens on 4.5 and older, with summarized display in both modes |
