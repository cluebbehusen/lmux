"""Native Anthropic-on-Bedrock tool calling: a weather prompt returns a get_weather tool call
with a JSON location argument, and cost matches the published rate.
"""
...
_CASSETTE = Path(__file__).parent.parent / "cassettes" / "anthropic" / "bedrock_tool_calls.json"
