"""OpenAI prompt-cache cost: a cassette and the live endpoint satisfy the same cost
contract for cache writes and reads. ``gpt-5.6-terra`` bills cache writes (older
models write for free), exercising both the cache-creation and cache-read paths.
"""
